        ...
        <div className={`navbar ${show && 'nav__scroll'} ${cName}`}>
            <Link to="/">
                <div className="logo__container">
                    ...
                    <p style={{color:"white",fontSize:"2rem"}}>Soy Keylen</p>
                </div>
            </Link>


            <div className="click__menu" onClick={()=> setOpen(!open)}><svg style={{color:"white"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
</svg></div>
            <div className="nav__content" style={{ display: open ? "flex" : "flex", left: open ? "0" : "-100%"}}>
                <Link to="/" className="nav__link" style={{marginTop:"-12px"}}><span style={{fontSize:"1rem"}}>Home</span></Link>
                <Link to="/Blog" className="nav__link" style={{marginTop:"-12px"}}><span style={{fontSize:"1rem"}}>Blog</span></Link>
                <Link to="/Portfolio" className="nav__link" style={{marginTop:"-12px"}}><span style={{fontSize:"1rem"}}>Portfolio</span></Link>
